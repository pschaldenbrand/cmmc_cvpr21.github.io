...
[__Ali Jahanian__](http://people.csail.mit.edu/jahanian/) With a background in visual arts, painting, and design, Ali received his MS and PhD from School of Electrical and Computer Engineering at Purdue University where his studies and developments of innovate software tools were supported by HP Labs Palo-Alto. His PhD dissertation titled “Quantifying Aesthetics of Visual Design, Applied to Automatic Design” received the Springer’s Best of The Best Theses Award. Ali then joined MIT where he did three postdocs focusing on human vision and HCI for design, AI and HCI for design of social media, and AI for computer vision and robotics applications. Currently, Ali is a research scientist at CSAIL MIT where he has been developing the notion of “Learning by Generating” in his work. Ali is an active referee and reviewer as well as programs committee member in both HCI and computer vision communities, has been organizing and teaching “Deep Learning for Art, Aesthetics, and Creativity” MIT IAP EECS series, and always gets inspired by creative work!
<!--is a research scientist at MIT. His research focuses on AI and creativity. In particular, developments from his work demonstrate three main applications: 1) Learning by generating, 2) Personalized creativity support tools to augment and democratize creativity, and 3) Learning theories of cognition and creativity.
-->
